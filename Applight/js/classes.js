...
let magalu = new Empresa("1",'Assist. de vendas', 'Magalu', 1589.16, './images/empresas/magalu.png')
let bris = new Empresa("2",'Técnico em redes', 'Brisanet', 10589.16, './images/empresas/bris.png')
let hapv = new Empresa("3",'Assist. de vendas', 'Hapvida', 1719.16, './images/empresas/hapv.png')
let fp = new Empresa("4",'Assist. de vendas', 'Farmacia permanente', 1589.16, './images/empresas/fp.png')
